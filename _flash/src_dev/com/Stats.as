...
package com
{
        ...
        {       
                ...
                protected var min_fps:Number=60;
                ...
                protected var theme : Object = { bg: 0x000033, fps: 0x8f8f8f, ms: 0x00ff00, mem: 0x00ffff, memmax: 0xff0070 }; 
                ...
                public function Stats( _theme : Object = null ) : void
                {
                        ...
                        xml = <xml><fps>FPS:</fps></xml>;//<ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax></xml>;
                
                        style = new StyleSheet();
                        style.setStyle("xml", {fontSize:'9px', fontFamily:'Helvetica,Arial,_sans', leading:'-2px', textAlign:'right', fontWeight:'bold'});
                ...
                private function update(e : Event) : void
                {
                        ...
                        if( timer - 1000 > ms_prev )
                        {
                               ...
                               // xml.fps = "FPS: " + fps + " / " + stage.frameRate;
                                xml.fps = fps+ " FPS (" + min_fps + "-" + stage.frameRate+")";
                              // xml.mem = "MEM: " + mem;
