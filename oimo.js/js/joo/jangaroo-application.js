...
// FROM net.jangaroo:jangaroo-runtime:0.8.1:
...
// FROM net.jangaroo:jangaroo-browser:0.8.2:
joo.loadModule("net.jangaroo","jangaroo-browser");

// FROM net.jangaroo.examples:hello-world:0.1.1-SNAPSHOT:
joo.loadModule("net.jangaroo.examples","hello-world");
